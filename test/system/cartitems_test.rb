...
class CartitemsTest < ApplicationSystemTestCase
  ...
  test "should create cartitem" do
    ...
    fill_in "Cartitem", with: @cartitem.cartitem_id
    fill_in "Line total", with: @cartitem.line_total
    fill_in "Product", with: @cartitem.product_id
    fill_in "Quantity", with: @cartitem.quantity
    fill_in "User", with: @cartitem.user_id
