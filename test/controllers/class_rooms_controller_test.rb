...
class ClassRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_room" do
    assert_difference("ClassRoom.count") do
      post class_rooms_url, params: { class_room: { available: @class_room.available, name: @class_room.name, start_time: @class_room.start_time } }
    end
  ...
  test "should update class_room" do
    patch class_room_url(@class_room), params: { class_room: { available: @class_room.available, name: @class_room.name, start_time: @class_room.start_time } }
